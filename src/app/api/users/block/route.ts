...
export async function POST(req: Request) {
    try {
        ...
        if (action === 'block') {
            ...
            const isAlreadyBlocked = currentUser.blockedUsers.some((id: any) => id.toString() === targetUserId);
            if (!isAlreadyBlocked) {
            ...
            const isAlreadyBlockedBy = targetUser.blockedBy.some((id: any) => id.toString() === decoded.userId);
