...
export async function POST(req: Request, { params }: { params: { id: string } }) {
    try {
        ...
        const receiver = chat?.participants.find((p: any) => p._id.toString() !== currentUserId);
...
export async function PUT(req: Request, { params }: { params: { id: string } }) {
    try {
        ...
        const existingReactionIndex = message.reactions.findIndex((r: any) => r.user.toString() === currentUserId);
