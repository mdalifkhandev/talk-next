    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-2 sm:p-4">
      <div className="bg-gray-900 rounded-xl overflow-hidden shadow-2xl w-full max-w-5xl p-3 sm:p-4 md:p-6 max-h-[95vh] flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4 flex-1 min-h-0">
          {/* My Video */}
          <div className="relative bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center min-h-50 sm:min-h-62.5 md:min-h-75">
            {stream && (
              <video
                playsInline
                muted
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mt-4 sm:mt-6 flex-wrap">
          <Button
            variant="outline"
            size="lg"
            className="rounded-full h-11 w-11 sm:h-12 sm:w-12 p-0"
            onClick={toggleMute}
          >
            {isMuted ? (
          ...
          {isIncoming && !callAccepted ? (
            <Button
              variant="default"
              size="lg"
              className="bg-green-500 hover:bg-green-600 rounded-full h-12 w-12 sm:h-14 sm:w-14 p-0 animate-pulse"
              onClick={answerCall}
            >
          ...
          <Button
            variant="default"
            size="lg"
            className="bg-red-500 hover:bg-red-600 rounded-full h-12 w-12 sm:h-14 sm:w-14 p-0"
            onClick={leaveCall}
          >
