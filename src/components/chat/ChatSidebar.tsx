...
import { User, Search, MessageCircle, LogOut, UserCircle, Menu, X } from 'lucide-react';
...
export default function ChatSidebar({ onSelectChat, currentUser, onNotificationClick }: ChatSidebarProps) {
                    ...
                    {users.map((user) => (
                        ...
                        >
                            <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                                {user.image ? (
                                    <img src={user.image} alt={user.name} className="h-10 w-10 sm:h-12 sm:w-12 rounded-full object-cover" />
                                ) : (
